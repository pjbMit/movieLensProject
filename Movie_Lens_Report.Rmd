...
if(runningInScript) {
    ...
    movieDataWithGenre <-tibble(myPreProcess(rbind(d1,d2))) # Preprocess and get subsets of the data
...
# Here we run the model multipe times to tune the model basedon the value of lambda.
if(runningInScript){
    #RunningInScript
    print("RunningInScript is TRUE")
