...
again.
```{r Load_edx_and_validation}
#This code allows me to load pre-saved objects, rather than having to recalculate them each time.

# load the data from the saved file, if the loadFromFile parameter is true. Otherwise, no-op.
edx <- restoreEdx(loadFromFile && load_edx_and_validation)
validation <- restoreValidation(loadFromFile && load_edx_and_validation)
